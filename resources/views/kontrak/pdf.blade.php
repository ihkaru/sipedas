...
<head>
    ...
    $c = now()->setLocale('id_ID')->settings(['formatFunction'=>'translatedFormat']);
...
<body>
    ...
    <p style="padding-top: 11pt; padding-left: 5pt; text-indent: 0pt; text-align: justify;">
        ...
        lampiran dokumen perjanjian kerja ini Tahun {{$c::parse($firstAlokasi->tanggal_akhir_perjanjian)->year}} pada
        Badan Pusat
    ...
    <h1 style="padding-left: 5pt; text-indent: 0pt; text-align: justify">
        ...
        <span class="p">sebagai {{ucwords($jabatanSurat)}} pada Badan Pusat Statistik Kabupaten
            Mempawah, dengan lingkup pekerjaan yang ditetapkan oleh </span>PIHAK PERTAMA<span class="p">.</span>
    </h1>
    <p style="text-indent: 0pt; text-align: left"><br /></p>
    <h1 style="text-indent: 0pt; text-align: center">
        Pasal 2
    ...
    <table style="border-collapse: collapse; margin-left: 74.7pt" cellspacing="0">
        <tr style="height: 79pt">
            <td style="width: 160pt">
                <p class="s2" style="padding-left: 2pt; text-indent: 0pt; line-height: 14pt; text-align: center;">
                    PIHAK KEDUA<span class="s3">,</span>
                </p>
                <p style="text-indent: 0pt; text-align: left"><br /><br /><br /><br /></p>
                <p class="s3" style="padding-left: 0pt; text-indent: 0pt; line-height: 13pt; text-align: center;">
                    {{-- PERUBAHAN: Mengambil nama dari relasi 'mitra' --}}
                    {{$firstAlokasi->mitra->nama_1}}
                </p>
            </td>
            <td style="width: 185pt">
                <p class="s2" style="padding-left: 67pt; text-indent: 0pt; line-height: 14pt; text-align: center;">
                    PIHAK PERTAMA<span class="s3">,</span>
                </p>
                <p style="text-indent: 0pt; text-align: left"><br /><br /><br /><br /></p>
                <p class="s3" style="padding-left: 63pt; text-indent: 0pt; line-height: 13pt; text-align: center;">
                    {{$ppk->nama}}
                </p>
            </td>
        </tr>
    ...
    <table style="border-collapse: collapse; margin-left: 6.17pt" cellspacing="0">
        ...
        <tr style="height: 20pt">
            ...
            <td style="width: 100pt; border: 1pt solid black;">
                ...
                <p style="padding: 10pt; text-align: center">{{ ucwords($istilahJabatan[$alokasi->honor->jabatan] ??
                    $alokasi->honor->jabatan) }}</p>
            </td>
            <td style="width: 100pt; border: 1pt solid black;">
                <p style="padding: 10pt; text-align: center">{{ ucwords(strtolower($alokasi->honor->jenis_honor)) }}</p>
            </td>
            <td style="padding: 10pt; border: 1pt solid black;">
                {{-- PERUBAHAN: Mengambil target dari alokasi dan satuan dari honor --}}
                <p style="text-indent: 0pt; text-align: center">{{ $alokasi->target_per_satuan_honor . " " .
                    $alokasi->honor->satuan_honor }}</p>
            </td>
            <td style="padding: 10pt; border: 1pt solid black;">
                {{-- PERUBAHAN: Mengambil harga satuan dari relasi honor --}}
                <p style="text-indent: 0pt; text-align: center">Rp.{{ $number::format($alokasi->honor->harga_per_satuan)
                    }}</p>
            </td>
            <td style="padding: 10pt; border: 1pt solid black;">
                {{-- PERUBAHAN: Mengambil total honor dari kolom alokasi --}}
                <p style="text-indent: 0pt; text-align: left">Rp.{{ $number::format($alokasi->total_honor) }}</p>
            </td>
        </tr>
        @endforeach
        ...
        <tr style="height: 20pt">
            <td colspan="7" style="padding: 10pt; border: 1pt solid black;">
                <p style="text-indent: 0pt; text-align: center">Terbilang: {{ ucwords($bil::make($totalHonor)) }} rupiah
                </p>
            </td>
        </tr>
    </table>
