...
class PengajuanPolicy
{
    ...
    {
        return $user->can('create_sipancong::pengajuan');
    }
    ...
    {
        return $user->can('update_sipancong::pengajuan');
    }
    ...
    {
        return $user->can('delete_sipancong::pengajuan');
    }
    ...
    {
        return $user->can('delete_any_sipancong::pengajuan');
    }
    ...
    {
        return $user->can('force_delete_sipancong::pengajuan');
    }
    ...
    {
        return $user->can('force_delete_any_sipancong::pengajuan');
    }
    ...
    {
        return $user->can('restore_sipancong::pengajuan');
    }
    ...
    {
        return $user->can('restore_any_sipancong::pengajuan');
    }
    ...
    {
        return $user->can('replicate_sipancong::pengajuan');
    }
    ...
    {
        return $user->can('reorder_sipancong::pengajuan');
    }
}
