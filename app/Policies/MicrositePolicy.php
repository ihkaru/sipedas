...
class MicrositePolicy
{
    ...
    {
        return $user->can('delete_microsite');
    }
    ...
    {
        return $user->can('delete_any_microsite');
    }
    ...
    {
        return $user->can('force_delete_microsite');
    }
    ...
    {
        return $user->can('force_delete_any_microsite');
    }
    ...
    {
        return $user->can('restore_microsite');
    }
    ...
    {
        return $user->can('restore_any_microsite');
    }
    ...
    {
        return $user->can('replicate_microsite');
    }
